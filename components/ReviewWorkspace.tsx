...
export default function ReviewWorkspace({
   ...
   * is still open. A resolved finding has no Approve button and no Reject
   * button on screen — undoing is the only decision left, and it is not one a
   * reviewer should be able to take blind — so A and R are simply unbound.
   */
  const openFinding =
    selected && selected.status === "open" ? selected : undefined;
